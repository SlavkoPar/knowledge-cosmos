...
import { ActionTypes, FormMode, IGroup, IGroupKey, IAnswer, IAnswerFormProps } from "groups/types";
...
const AnswerForm = ({ mode, answer, submitForm, children, showCloseButton, source = 0, closeModal }: IAnswerFormProps) => {
  ...
  const setParentGroup = (grp: IGroup) => {
    formik.setFieldValue('parentGroup', grp.id);
